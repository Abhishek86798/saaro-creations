...
const OfficePage = () => {
  ...
  const allOfficeProducts = getProductsByCategory('Office');
  
  const categories = [
    { id: 'all', name: 'All Office', image: '/images/officehome/Office_Desks-image.jpg' },
    { id: 'Desks', name: 'Desks', image: '/images/officehome/Office_Desks-image.jpg' },
    { id: 'Office Chairs', name: 'Office Chairs', image: '/images/officehome/Office_Chairs-image.jpg' },
    { id: 'Bookcases', name: 'Bookcases', image: '/images/officehome/Bookcases-image.jpg' },
    { id: 'Storage', name: 'Storage', image: '/images/officehome/Office_Storage-image.jpg' },
  ];

  const filteredProducts = useMemo(() => {
    let filtered = allOfficeProducts;
    ...
    return filtered;
  }, [allOfficeProducts, selectedCategory, filters]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8 overflow-hidden">
          ...
          <div className="flex-1">
            ...
            />
            <ProductGrid products={filteredProducts} emptyMessage={selectedCategory ? `No products found in ${selectedCategory}` : 'No office products found'} />
          </div>
        </div>
      </div>
    </div>
