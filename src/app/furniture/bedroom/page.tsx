...
const BedroomPage = () => {
  ...
  const allBedroomProducts = getProductsByCategory('Bedroom');
  
  const categories = [
    { id: 'all', name: 'All Bedroom', image: '/images/bedroom/Zigzag_Wardrobe_4_Shutter.webp' },
    { id: 'Beds', name: 'Beds', image: '/images/bedroom/Rylaan_Bed_Cot.webp' },
    { id: 'Nightstands', name: 'Nightstands', image: '/images/bedroom/Barrett_Reaper_Nightstand.webp' },
    { id: 'Wardrobes', name: 'Wardrobes', image: '/images/bedroom/Zigzag_Wardrobe_2_Shutter.webp' },
    { id: 'Dressers', name: 'Chest of Drawers', image: '/images/bedroom/Alden_Chest_of_Drawer_S.webp' },
    { id: 'Benches', name: 'Benches & Ottomans', image: '/images/bedroom/Meraki_Upholstered_Bench.webp' },
  ];

  const filteredProducts = useMemo(() => {
    let filtered = allBedroomProducts;
    ...
    return filtered;
  }, [allBedroomProducts, selectedCategory, filters]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8 overflow-hidden">
          ...
          <div className="flex-1">
            ...
            />
            <ProductGrid products={filteredProducts} emptyMessage={selectedCategory ? `No products found in ${selectedCategory}` : 'No bedroom products found'} />
          </div>
        </div>
      </div>
    </div>
