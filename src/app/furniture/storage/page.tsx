...
const StoragePage = () => {
  ...
  const allStorageProducts = getProductsByCategory('Storage');
  
  const categories = [
    { id: 'all', name: 'All Storage', image: '/images/storage/Storage_Cabinets-image.jpg' },
    { id: 'Cabinets', name: 'Cabinets', image: '/images/storage/Storage_Cabinets-image.jpg' },
    { id: 'Sideboards', name: 'Sideboards', image: '/images/storage/Sideboards-image.jpg' },
    { id: 'Display Units', name: 'Display Units', image: '/images/storage/Display_Units-image.jpg' },
    { id: 'Shelving', name: 'Shelving', image: '/images/storage/Shelving-image.jpg' },
  ];

  const filteredProducts = useMemo(() => {
    let filtered = allStorageProducts;
    ...
    return filtered;
  }, [allStorageProducts, selectedCategory, filters]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8 overflow-hidden">
          ...
          <div className="flex-1">
            ...
            />
            <ProductGrid products={filteredProducts} emptyMessage={selectedCategory ? `No products found in ${selectedCategory}` : 'No storage products found'} />
          </div>
        </div>
      </div>
    </div>
