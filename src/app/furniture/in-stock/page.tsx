...
const InStockPage = () => {
  ...
  // Filter for ready to ship products
  ...
  const filteredProducts = useMemo(() => {
    let filtered = allInStockProducts;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8 overflow-hidden">
          ...
          <div className="flex-1">
            ...
            />
            <ProductGrid products={filteredProducts} emptyMessage="No in-stock products found" />
          </div>
        </div>
      </div>
    </div>
